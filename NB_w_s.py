...
def NB(prior,file_paths_test,cond_prob,true_label):
    c_p = 0;
    in_p = 0;
...
if __name__=='__main__':
    ...
    ham_train_words  =  all_words(ham_train_files)
    spam_train_words = all_words(spam_train_files)
    ...
    c_p_ham, in_p_ham = NB(prior,ham_test_files,combined_conditional,'ham') 
    # ham accuracy
    ham_accuracy = c_p_ham/(c_p_ham + in_p_ham)
    
    c_p_spam, in_p_spam = NB(prior,spam_test_files,combined_conditional,'spam') 
